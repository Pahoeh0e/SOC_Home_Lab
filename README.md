...
### Lab Topology
             ...
             │                                                                                       │
             │  ┌─────────────┐         ┌─────────────┐       ┌─────────────┐    ┌─────────────┐     │
             │  │   Kali      │         │   Windows   │       │   DMZ VM    │    │   DMZ VM    │     │
             │  │  (Attacker) │         │   Server    │       │ (Snort IDS) │    │ (Snort IDS) │     │
             │  │  10.0.10.10 │◄───────►│  10.0.20.10 │◄─────►│  10.0.30.50 │    │  10.0.30.50 │     │
             │  │             │         │  - AD DS    │       │             │    │             │     │
             │  │  Tools:     │         │  - Sysmon   │       │  - Snort    │    │  - Snort    │     │
             │  │  Nmap       │         │  - Splunk UF│       │  - Splunk UF│    │  - Splunk UF│     │
             │  │  Metasploit │         │  - Wazuh Ag │       │  - Wazuh Ag │    │  - Wazuh Ag │     │
             │  │  Hydra      │         │             │       │             │    │             │     │
             │  │  Mimikatz   │         │             │       │             │    │             │     │
             │  └──────┬──────┘         └──────┬──────┘       └──────┬──────┘    └──────┬──────┘     │
             │         │                       │                     │                  │            │
